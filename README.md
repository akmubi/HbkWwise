...
## Disclaimer
The tool assists with replacing and arranging game audio. It **does not** automatically split or adapt an imported song to fit music segments. You must cut, arrange, and align the audio to the appropriate BPM and cues yourself.
...
## Issues/Bugs
If you found a bug or an issue, go to the [issues](https://github.com/akmubi/HbkWwise/issues), describe the problem and **attach screenshot** and **log** (from View / Log).
